...
class LocationMovementApprovalInform extends Mailable
{
    ...
    public function build()
    {
        ...
        return $this->from(env('MAIL_FROM_ADDRESS'))->view('mails.locationmovementapproved')->with([
            ...
            'locationMovement'=>$this->locationMovement,
