...
class LocationMovementRequest extends Mailable
{
    ...
    public function build()
    {
        ...
        return $this->from('support@salesforce.com')->view('mails.locationmovementcreate')->with([
            ...
            'claimRoute'=>QuickTaskFacade::locationClaimRoute($this->locationMovement->id),
