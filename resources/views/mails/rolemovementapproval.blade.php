              ...
              <td style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;"><!-- ======= start header ======= -->
                ...
                <table class="one-column" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-spacing:0; border-left:1px solid #e8e7e5; border-right:1px solid #e8e7e5; border-bottom:1px solid #e8e7e5; border-top:1px solid #e8e7e5" bgcolor="#FFFFFF">
                    ...
                    <strong>Hello</strong>,</p>
                      ...
                      The role movement request made by <strong>{{$requesterName}} </strong> on {{$time}}, 
                      to move <strong>{{$resourceName}} </strong> from the position of {{$resourceRole}} to {{$destinationRole}} has been <strong> approved</strong>
                        <br />
                        <br />
                        ...
                        <tbody>
                          <tr>
                            <td align="center"><table border="0" cellpadding="0" cellspacing="0" style="Margin:0 auto;">
                                <tr>
                                  <td width="250" height="60" align="center" bgcolor="#ce283d" style="-moz-border-radius: 30px; -webkit-border-radius: 30px; border-radius: 30px;"><a href="{{route('login')}}" style="width:250; display:block; text-decoration:none; border:0; text-align:center; font-weight:bold;font-size:18px; font-family: Arial, sans-serif; color: #ffffff" class="button_link">Home<img src="https://gallery.mailchimp.com/fdcaf86ecc5056741eb5cbc18/images/c3ae861e-3e57-4c03-b5b7-5d9882a3b5c8.jpg" width="32" height="17" style="padding-top:5px" alt="" border="0"/></a></td>
                                </tr>
                              </table></td>
                          </tr>
                        </tbody>
