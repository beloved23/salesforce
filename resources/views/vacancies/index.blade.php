							...
							<div class="right-page-header">
								<div class="pull-right">
								  ...
								  <div class="btn-group">
                                    ...
                                    <li><a href="{{route('vacancies.index')}}?location=ROD">Region/ROD</a></li>
                                    <li><a href="{{route('vacancies.index')}}?location=ZBM">Zone/ZBM</a></li>
									 <li><a href="{{route('vacancies.index')}}?location=ASM">Area/ASM</a></li>
									  <li><a href="{{route('vacancies.index')}}?location=MD">Territory/MD</a></li>
														</ul>
													</div>
